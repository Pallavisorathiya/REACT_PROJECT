    ...
    <Container className="add-product-container">
      ...
      <Form className="mt-4" onSubmit={handleSubmit}>
        ...
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm="6">
            <Form.Control type="text"name="title" placeholder="Enter Title"value={inputForm.title} onChange={handleChanged}isInvalid={!!errors.title}/>
        ...
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm="6">
            <Form.Control type="text"
              placeholder="Enter Amount of product (Kg, g, L, ml, units)"
              name="amount" value={inputForm.amount} onChange={handleChanged}isInvalid={!!errors.amount}/>
        ...
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm="6">
            <Form.Control as="textarea"rows={3}placeholder="Enter detailed product description" name="desc"value={inputForm.desc} onChange={handleChanged} isInvalid={!!errors.desc}/>
        ...
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm="6">
            <Form.Control type="number"name="price" placeholder="Enter Price"value={inputForm.price}onChange={handleChanged}isInvalid={!!errors.price} />
        ...
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm="6">
            <Form.Control type="text"name="image" placeholder="Enter Image URL"value={inputForm.image} onChange={handleChanged}isInvalid={!!errors.image}/>
