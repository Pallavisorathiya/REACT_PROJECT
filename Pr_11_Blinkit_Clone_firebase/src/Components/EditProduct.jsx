        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group as={Row} className="mb-3">
            ...
            <Col sm="10">
              ...
              <Form.Control.Feedback type="invalid"> {errors.desc}
              </Form.Control.Feedback>
            </Col>
          </Form.Group>
          ...
          <Form.Group as={Row} className="mb-3">
            ...
            <Col sm="10">
              ...
              />
              <Form.Control.Feedback type="invalid">{errors.price}
              </Form.Control.Feedback>
            </Col>
          </Form.Group>
          ...
          <Form.Group as={Row} className="mb-3">
            ...
            <Col sm="10">
              <Form.Select
                ...
                onChange={handleChanged} isInvalid={!!errors.category} >
              ...
              <Form.Control.Feedback type="invalid"> {errors.category}
              </Form.Control.Feedback>
            </Col>
          </Form.Group>
