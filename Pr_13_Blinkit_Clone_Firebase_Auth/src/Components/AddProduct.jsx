...
const AddProduct = () => {
  ...
  const validate = () => {
    ...
    if (!inputForm.amount.trim()) err.amount = "Please enter amount";
    ...
    if (!inputForm.image.trim()) err.image = "Please upload an image";
    ...
    <Container className="add-product-container">
      ...
      <Form className="mt-4" onSubmit={handleSubmit}>
        ...
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm="6">
            <Form.Control
              type="text" name="title" placeholder="Enter Title" value={inputForm.title} onChange={handleChanged} isInvalid={!!errors.title}/>
        ...
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm="6">
            <Form.Control
              type="text"  name="amount" placeholder="Kg, g, L, ml, units"  value={inputForm.amount} onChange={handleChanged}  isInvalid={!!errors.amount} />
        ...
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm="6">
            <Form.Control
              as="textarea" rows={3} name="desc" placeholder="Enter product description"  value={inputForm.desc}  onChange={handleChanged} isInvalid={!!errors.desc} />
        ...
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm="6">
            <Form.Control
              type="number" name="price" placeholder="Enter Price" value={inputForm.price} onChange={handleChanged}  isInvalid={!!errors.price} />
        ...
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm="6">
            <Form.Select
              name="category" value={inputForm.category} onChange={handleChanged} isInvalid={!!errors.category}  >
        ...
        <Form.Group as={Row} className="mb-3">
          ...
          <Col sm="6">
            <Form.Control
              type="file" name="image"onChange={handleFileChanged}  isInvalid={!!errors.image} />
