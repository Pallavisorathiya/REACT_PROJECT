...
const ProductDetails = () => {
  ...
  const { user } = useSelector((state) => state.userReducer); // ✅ user info
  ...
  // Delete handler with login check
  const handleDelete = () => {
    if (!user) {
      navigate("/signIn");
      return;
  ...
  return (
    <Container className="py-4">
      ...
      {/* Remaining UI (Why shop from blinkit...) unchanged */}
      <div className="mt-5">
        ...
        <Row className="mt-3">
          ...
          <Col md={4} className="mb-3">
            <div className="p-3 border rounded shadow-sm h-100">
              ...
              <p className="mb-0 text-secondary">
                Choose from 5000+ products across food, personal care, household & more categories.
              </p>
            </div>
          </Col>
        </Row>
